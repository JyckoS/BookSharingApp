...
--
-- Host: localhost
-- Generation Time: Jun 22, 2024 at 12:27 PM
...
(1829, 1256, 'How to cook a lasagna underwater', 'Gordon Ramsay', 'Penguin Random House', 2016, 'Cooking', 'EXCELLENT', 'Learn how to cook a lasagna underwater with the guide of the world famous chef gordon ramsay', 'AVAILABLE', '1191202266', NULL);
...
(1234, '1191202266', '2024-06-04 16:00:00', 'I have that book and I don\'t use it anymore. I will share it!');
...
CREATE TABLE `forum_request` (
  ...
  `ForumPosts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '[]',
  `image_base64` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `manager` (`ManagerID`, `Email`, `Password`, `UserType`, `Name`, `image_base64`) VALUES
('MU121000', 'MU121000@mmu.edu.my', 'Jason123', 'MANAGER', 'Jason Statham', NULL);
...
INSERT INTO `students` (`StudentID`, `Name`, `Email`, `Password`, `UserType`, `image_base64`) VALUES
('1191202266', 'Sarah Butchman', '1191202266@student.mmu.edu.my', 'Sarah123', 'STUDENT', NULL),
('1191202277', 'Michael Jackson', '1191202277@student.mmu.edu.my', 'Michael123', 'STUDENT', NULL),
('1291202288', 'Johnny Depp', '1191202288@student.mmu.edu.my', 'Johnny123', 'STUDENT', NULL);
...
CREATE TABLE `wishlist` (
  ...
  `StudentID` varchar(30) NOT NULL,
  `Books` longtext NOT NULL DEFAULT '[]' COMMENT 'Stores data in form of book id, eg:\r\n[123, 4441,1231]'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
